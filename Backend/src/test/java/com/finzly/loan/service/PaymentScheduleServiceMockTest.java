...
class PaymentScheduleServiceMockTest {
	...
	void testPaymentSchedulefor_PrincipleType_InterestOnly_Frequency_HalfYearly() {
	...
	@org.junit.jupiter.api.Test
	void testPaymentSchedulefor_PrincipleType_EvenFrequency_HalfYearly() {
		PaymentScheduleRepository paymentScheduleRepository = mock(PaymentScheduleRepository.class);
		PaymentSchedule mockPaymentSchedule =new PaymentSchedule(0,LocalDate.of(2021,5,12),0,180,"projected",180);
		mockPaymentSchedule.setPaymentScheduleId(0);
		when(paymentScheduleRepository.save(any(PaymentSchedule.class))).thenReturn(mockPaymentSchedule);
	...
	@org.junit.jupiter.api.Test
	void testPaymentSchedulefor_PrincipleType_Even_Frequency_Yearly() {
		PaymentScheduleRepository paymentScheduleRepository = mock(PaymentScheduleRepository.class);
		PaymentSchedule mockPaymentSchedule =new PaymentSchedule(0,LocalDate.of(2021,5,12),0,180,"projected",180);
		mockPaymentSchedule.setPaymentScheduleId(0);
		when(paymentScheduleRepository.save(any(PaymentSchedule.class))).thenReturn(mockPaymentSchedule);
	...
	@org.junit.jupiter.api.Test
	void testPaymentSchedulefor_PrincipleType_InterestOnly_Frequency_Yearly() {
		PaymentScheduleRepository paymentScheduleRepository = mock(PaymentScheduleRepository.class);
		PaymentSchedule mockPaymentSchedule =new PaymentSchedule(0,LocalDate.of(2021,5,12),0,180,"projected",180);
		mockPaymentSchedule.setPaymentScheduleId(0);
		when(paymentScheduleRepository.save(any(PaymentSchedule.class))).thenReturn(mockPaymentSchedule);
	...
	@org.junit.jupiter.api.Test
	void testPaymentSchedulefor_PrincipleType_Even_Frequency_Quarterly() {
		PaymentScheduleRepository paymentScheduleRepository = mock(PaymentScheduleRepository.class);
		PaymentSchedule mockPaymentSchedule =new PaymentSchedule(0,LocalDate.of(2021,5,12),0,180,"projected",180);
		mockPaymentSchedule.setPaymentScheduleId(0);
		when(paymentScheduleRepository.save(any(PaymentSchedule.class))).thenReturn(mockPaymentSchedule);
	...
	@org.junit.jupiter.api.Test
	void testPaymentSchedulefor_PrincipleType_InterestOnly_Frequency_Quarterly() {
		PaymentScheduleRepository paymentScheduleRepository = mock(PaymentScheduleRepository.class);
		PaymentSchedule mockPaymentSchedule =new PaymentSchedule(0,LocalDate.of(2021,5,12),0,180,"projected",180);
		mockPaymentSchedule.setPaymentScheduleId(0);
		when(paymentScheduleRepository.save(any(PaymentSchedule.class))).thenReturn(mockPaymentSchedule);
	...
	@org.junit.jupiter.api.Test
	void testPaymentSchedulefor_PrincipleType_Even_Frequency_Monthly() {
	...
	@org.junit.jupiter.api.Test
	void testPaymentSchedulefor_PrincipleType_InterestOnly_Frequency_Monthly() {
		PaymentScheduleRepository paymentScheduleRepository = mock(PaymentScheduleRepository.class);
		PaymentSchedule mockPaymentSchedule =new PaymentSchedule(0,LocalDate.of(2021,5,12),0,180,"projected",180);
		mockPaymentSchedule.setPaymentScheduleId(0);
		when(paymentScheduleRepository.save(any(PaymentSchedule.class))).thenReturn(mockPaymentSchedule);
	...
	@org.junit.jupiter.api.Test
	void testPaymentSchedulefor_PrincipleType_InterestOnly_Frequency_Monthly_With_DifferentStartDate() {
	...
	@org.junit.jupiter.api.Test
	void testPaymentSchedulefor_PrincipleType_InterestOnly_Frequency_Yearly_For_TwoYears() {
		PaymentScheduleRepository paymentScheduleRepository = mock(PaymentScheduleRepository.class);
		PaymentSchedule mockPaymentSchedule =new PaymentSchedule(0,LocalDate.of(2021,5,12),0,180,"projected",180);
		mockPaymentSchedule.setPaymentScheduleId(0);
		when(paymentScheduleRepository.save(any(PaymentSchedule.class))).thenReturn(mockPaymentSchedule);
	...
	@org.junit.jupiter.api.Test
	void testPaymentSchedulefor_PrincipleType_InterestOnly_Frequency_Yearly_For_ThreeYears() {
...
//	}
	...
	@org.junit.jupiter.api.Test
	void testListAllPaymentSchedules() {
